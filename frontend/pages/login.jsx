    ...
    return (
        <div className={style.loginContainer}>
            ...
            <form method="POST" id="loginForm" className={style.loginContainer__form}>
                <h1 className={style.loginContainer__form__title}> Connectez-vous ! </h1>
                ...
                <span className={style.loginContainer__div__form__errorHandler} id="errorHandler"></span>
                <InputGroup id="submit" type="submit" value="Connexion" onClick={handleSubmit} />
                <p>
                    Pas de compte ?
                    <Link href="/signup">
                        <a className={style.loginContainer__form__link}> Inscrit toi !</a>
                    </Link>
                </p>
            </form>
